  ...
  async function logMovies() {
    try {
      const apiUrl = await fetch(
        `${BASE_URL}/everything?q=${params?.query}&apiKey=${API_KEY}`
      );
      if (!apiUrl.ok) {
          ...
          {loading ? (
            ...
            <div className="container mx-auto">
              <div className="flex flex-row align-middle justify-center pt-5">
                ...
                <p style={{ color: "#858585" }}>:{params.query}</p>
              </div>
                ...
                >
                  {news?.slice(0, 10).map(
                    (data, index) =>
                      data.urlToImage && (
                        <div
                          className="row-span-1 col-span-1 card mx-auto  "
                          key={index}
                        >
                          <a
                            href={data.url}
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Subscribe our newsletter for latest news around the
                        world. Let's stay updated!
                      </p>
                    </div>
